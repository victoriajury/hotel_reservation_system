...
import ReservationView, { loader as reservationViewLoader }  from './pages/ReservationView';
import ReservationForm, { loader as reservationFormLoader, action as reservationFormAction  }  from './pages/ReservationForm';
